...
BUSYBOX_TARBALL = $(call qstrip,$(BR2_PACKAGE_BUSYBOX_CUSTOM_TARBALL_LOCATION))
BUSYBOX_SITE = $(patsubst %/,%,$(dir $(BUSYBOX_TARBALL)))
BUSYBOX_SOURCE = $(notdir $(BUSYBOX_TARBALL))
BUSYBOX_STRIP_COMPONENTS = $(BR2_PACKAGE_BUSYBOX_CUSTOM_TARBALL_STRIP_COMPONENTS)
