...
ifeq ($(BR2_PACKAGE_BUSYBOX_CUSTOM_TARBALL),y)
BUSYBOX_VERSION = $(call qstrip,$(BR2_PACKAGE_BUSYBOX_CUSTOM_VERSION))
BUSYBOX_SITE = $(call qstrip,$(BR2_PACKAGE_BUSYBOX_CUSTOM_SITE))
BUSYBOX_SOURCE = busybox-$(BUSYBOX_VERSION).tar.xz
BUSYBOX_STRIP_COMPONENTS = $(BR2_PACKAGE_BUSYBOX_CUSTOM_STRIP_COMPONENTS)
BR_NO_CHECK_HASH_FOR += $(BUSYBOX_SOURCE)
else
