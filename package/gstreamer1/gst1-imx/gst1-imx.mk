...
ifeq ($(BR2_PACKAGE_GST1_IMX_CUSTOM_VERSION),y)
GST1_IMX_VERSION = $(call qstrip, $(BR2_PACKAGE_GST1_IMX_CUSTOM_VERSION_VALUE))
else
GST1_IMX_VERSION = 0.13.0-R20
endif
GST1_IMX_SITE = https://cgit.vaxpl.com/rdst/gstreamer-imx/snapshot
