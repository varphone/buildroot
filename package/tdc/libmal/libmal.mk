...
LIBMAL_SITE = https://cgit.vaxpl.com/rdst/libmal/snapshot
...
ifeq ($(BR2_PACKAGE_LIBXD_STREAM),y)
LIBMAL_DEPENDENCIES += libxd_stream
endif

ifeq ($(BR2_PACKAGE_LIBXD_MUXER),y)
LIBMAL_DEPENDENCIES += libxd_muxer
endif
