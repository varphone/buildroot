...
LIBPES_LEGACY_MAKE_ENV += BUILD_STATIC=y
endif
...
define LIBPES_LEGACY_INSTALL_STAGING_CMDS
	$(MAKE1) $(LIBPES_LEGACY_MAKE_ENV) -C $(@D) install DESTDIR=$(STAGING_DIR) PREFIX=/usr
endef

define LIBPES_LEGACY_INSTALL_TARGET_CMDS
	$(MAKE1) $(LIBPES_LEGACY_MAKE_ENV) -C $(@D) install-bin DESTDIR=$(TARGET_DIR) PREFIX=/usr
endef
