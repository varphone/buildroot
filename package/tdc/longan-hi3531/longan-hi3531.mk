...
ifeq ($(BR2_PACKAGE_LONGAN_HI3531_TARGET),)
LONGAN_HI3531_CONF_OPTS += -DHI3531_TARGET=longan
else
LONGAN_HI3531_CONF_OPTS += -DHI3531_TARGET=$(call qstrip, $(BR2_PACKAGE_LONGAN_HI3531_TARGET))
endif
